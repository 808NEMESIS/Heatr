...
GDPR_DATA_MAP: dict[str, dict] = {
    ...
    "founding_five_slots":   {"action": "redact", "by": "lead_id", "export": True,
                              "redact_columns": {"lead_id": None, "notes": None},
                              "reason": "getekende-deal-slot: persoonlijke link (lead_id) eruit, slot-telling (niche) blijft voor Founding-Five-integriteit"},
